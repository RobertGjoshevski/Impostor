...
export const SetupView = {
            ...
            <section class="bg-surface-container-high rounded-xl p-5 shadow-[0_0_32px_rgba(208,149,255,0.04)] flex flex-col gap-6">
                ...
                <div class="flex items-center justify-between bg-surface-container-low rounded-lg p-4 cursor-pointer hover:bg-surface-container-highest transition-colors active:scale-95" id="openThemesBtn">
                    <div class="flex flex-col">
                        ...
                        <span id="themesCountSpan" class="font-body text-xs text-on-surface-variant">${t(state.language, 'themesSelected', { sel: state.selectedThemes.length, avail: state.availableThemes.length })}</span>
                    </div>
    ...
    update: (state) => {
        ...
        document.getElementById('themesCountSpan').innerText = t(state.language, 'themesSelected', { sel: state.selectedThemes.length, avail: state.availableThemes.length });
